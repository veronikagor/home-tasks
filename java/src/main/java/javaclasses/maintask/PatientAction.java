...
public class PatientAction {
    ...
    public static ArrayList<Patient> printListOfPatientsWithASpecificDiagnosis(String diagnosis) {
    ...
    public static ArrayList<Patient> printListOfPatientsWithAMedicalRecordNumberIsInASpecificInterval(int fromNumber, int toNumber) {
